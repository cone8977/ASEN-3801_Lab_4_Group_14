% Contributors : Saketh Guttapalli, Cody Newton , Victor Turpin Aguayo , Liz Thompson
...
fig = 1:6;
PlotAircraftSim(T,y,[Z_c,L_c,M_c,N_c],fig,['b'; 'b'; 'b'; 'b'; 'b'; 'b';'k'], '15')


exportgraphics(figure(6),'3D_Trajectory_For_Velocity_deviation.png')
exportgraphics(figure(4),'Body_Angular_Rates_Components_For_Velocity_deviation.png')
exportgraphics(figure(2),'Body_Angular_Components_For_Velocity_deviation.png')
exportgraphics(figure(1),'Inertial_Position_Components_For_Velocity_deviation.png')
